...
<div class="min-h-screen bg-gray-900 text-white">
  <!-- Header -->
  <div
    class="bg-gradient-to-r from-[#18122B] via-[#232946] to-[#0A0A0A] border-b border-[#00F5FF]/20"
  >
    <div class="max-w-4xl mx-auto px-4 py-6">
      <div class="flex items-center justify-between">
        <BackButton />
        <h1
          class="text-2xl font-bold bg-gradient-to-r from-[#00F5FF] via-[#9D4EDD] to-[#FF6B6B] bg-clip-text text-transparent"
        >
          Your Tickets
        </h1>
        <div class="w-8"></div>
  ...
  <div class="max-w-4xl mx-auto px-4 py-8">
    {#if loading}
      <div class="flex items-center justify-center py-12">
        <div
          class="animate-spin rounded-full h-12 w-12 border-b-2 border-[#00F5FF]"
        ></div>
      </div>
    {:else if error}
    ...
    {:else if ticketData}
      ...
      <div class="text-center mb-8">
        <div
          class="inline-flex items-center gap-2 p-4 bg-green-900/20 border border-green-500/30 rounded-lg mb-4"
        >
          <svg
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div>
            ...
            <div class="text-white font-medium">
              {ticketData.paymentMethod === "orange_money"
                ? "Orange Money SL"
                : "Credit/Debit Card"}
            </div>
          </div>
              ...
              <div class="bg-gray-700 rounded-lg p-4">
                <div class="text-center">
                  ...
                  <img
                    src={ticket.qrCode}
                    alt="QR Code"
                    class="mx-auto w-24 h-24 bg-white rounded"
                  />
                </div>
              </div>
            {/each}
      ...
      <div
        class="bg-gradient-to-br from-[#18122B] via-[#232946] to-[#0A0A0A] border border-[#9D4EDD]/30 rounded-xl p-6 mb-6"
      >
        <div class="text-center">
          <h3
            class="text-xl font-semibold mb-2 bg-gradient-to-r from-[#9D4EDD] to-[#00F5FF] bg-clip-text text-transparent"
          >
            Want Web3 Benefits?
          </h3>
          <p class="text-gray-300 mb-4">
            Connect your wallet to unlock transferable tickets, lower fees, and
            true ownership.
          </p>
        ...
        <div class="space-y-3 text-sm">
          ...
          <div class="flex justify-between">
            ...
            <span class="text-gray-300"
              >{ticketData.expiresAt.toLocaleString()}</span
            >
          </div>
        </div>
        <div
          class="mt-4 p-3 bg-yellow-900/20 border border-yellow-500/30 rounded-lg"
        >
          <div class="flex items-center gap-2">
            ...
            <span class="text-xs text-yellow-400"
              >Save this page or download your tickets before the access
              expires.</span
            >
          </div>
        </div>
