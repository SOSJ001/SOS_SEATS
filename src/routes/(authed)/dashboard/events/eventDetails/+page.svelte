<script lang="ts">
  ...
  let eventData = {
    ...
    location: "The Electric Warehouse, 123 Rave St, City",
    description:
      "An electrifying night of music and lights featuring top DJs, immersive visuals, and a vibrant atmosphere. Get ready to dance until dawn!",
    image: "/api/placeholder/800/300",
    ticketsSold: 850,
    totalCapacity: 1000,
    totalRevenue: 42500,
    attendeesCheckedIn: 780,
