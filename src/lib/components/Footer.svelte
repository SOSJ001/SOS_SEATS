<script>
  // Footer component for SOS SEATS
</script>

<footer class="bg-[#18191c] text-white">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
      ...
      <div class="sm:col-span-2 lg:col-span-1">
        <div
          class="text-xl sm:text-2xl font-extrabold tracking-wide bg-gradient-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent mb-4"
          style="font-family: 'Roboto Slab', serif;"
        >
          SOS SEATS
        </div>
        <p class="text-gray-300 mb-6 leading-relaxed text-sm sm:text-base">
          Revolutionizing event seating with blockchain technology. Secure,
          transparent, and seamless ticket management for the modern world.
        </p>
      ...
      <div>
        <h3
          class="text-base sm:text-lg font-semibold mb-4 sm:mb-6 text-white"
          style="font-family: 'Roboto Slab', serif;"
        >
          Quick Links
        </h3>
        <ul class="space-y-2 sm:space-y-3">
          <li>
            <a
              href="/"
              class="text-gray-300 hover:text-cyan-400 transition-colors duration-300 text-sm sm:text-base"
            >
              Home
            </a>
          </li>
      ...
      <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-6 lg:space-y-0">
        ...
        <div class="w-full lg:w-auto">
          <div class="flex flex-col space-y-3 sm:flex-row sm:items-center sm:space-y-0 sm:space-x-4">
            <span class="text-gray-300 text-xs sm:text-sm text-center sm:text-left"
