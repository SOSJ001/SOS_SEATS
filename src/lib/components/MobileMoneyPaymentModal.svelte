    ...
    >
      ...
      {#if paymentStatus === "pending"}
        <button
          ...
          class="absolute top-3 right-3 sm:top-4 sm:right-4 z-20 w-7 h-7 sm:w-8 sm:h-8 bg-gray-800/50 hover:bg-gray-700/70 rounded-full flex items-center justify-center transition-all duration-200 hover:scale-110 group"
        >
          <svg
            class="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 group-hover:text-white transition-colors duration-200"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
      ...
      <!-- Main content -->
      <div class="relative z-10 p-4 sm:p-6 max-h-[90vh] overflow-y-auto">
        {#if paymentStatus === "pending"}
          <!-- Pending Payment -->
          <div class="text-center">
            <div class="mb-4 sm:mb-6">
              <div
                class="inline-flex items-center justify-center px-6 py-4 sm:px-8 sm:py-6 bg-white rounded-xl shadow-lg mb-4 border-2 {paymentMethod ===
                'orange_money'
            ...
            <!-- Loading indicator - moved up for visibility -->
            <div
              class="mb-4 sm:mb-6 flex items-center justify-center space-x-2 text-gray-300"
            >
              <svg
                class="animate-spin h-6 w-6 sm:h-7 sm:w-7 text-cyan-400"
            ...
            <div
              class="bg-gray-800/50 border-2 {paymentMethod === 'orange_money'
                ...
                : 'border-green-500/50'} rounded-lg p-4 sm:p-6 mb-4 sm:mb-6"
            >
              <div class="text-xs sm:text-sm text-gray-400 mb-2">
                USSD Code:
              </div>
              <div
                class="text-2xl sm:text-3xl font-mono font-bold {paymentMethod ===
                'orange_money'
                  ? 'text-orange-400'
            ...
            <div class="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
              <div
                class="flex justify-between items-center text-sm sm:text-base text-gray-300"
              >
                <span>Amount:</span>
              ...
              >
                ...
                <span
                  class="text-base sm:text-lg font-semibold {paymentMethod ===
                  'orange_money'
                    ? 'text-orange-400'
            ...
            <!-- Instructions -->
            <div
              class="bg-gray-900/50 rounded-lg p-3 sm:p-4 text-left text-xs sm:text-sm text-gray-400"
            >
